<div>
    <x-dialog-modal wire:model.live="modalServiceEdit" wire:click="$set('modalServiceEdit', false)" submit="edit">
        <x-slot name="title">
            Form Edit Service
        </x-slot>
        ...
        <x-slot name="footer">
            <x-secondary-button @click="$wire.modalServiceEdit = false" wire:loading.attr="disabled">
                Batal
            </x-secondary-button>
