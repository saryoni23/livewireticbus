<div>
    <x-button @click="$wire.modalTiketCreate = true">Create Tiket</x-button>

    <x-dialog-modal wire:model.live="modalTiketCreate" wire:click="$set('modalTiketCreate', false)" submit="save">
        <x-slot name="title">
            Form Tiket
        </x-slot>
        ...
        <x-slot name="footer">
            <x-secondary-button @click="$wire.modalTiketCreate = false" wire:loading.attr="disabled">
                Batal
            </x-secondary-button>
