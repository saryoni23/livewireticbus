...
<table class="w-full mt-2">
    <thead>
        <tr>
            ...
            <th @click="$wire.sortField('kota_asal')"
                class='p-2 whitespace-nowrap border border-spacing-1 cursor-pointer'>
                <x-sort :$sortDirection :$sortBy :field="'kota_asal'" />Kota Asal</th>
            <th @click="$wire.sortField('kota_tujuan')"
                class='p-2 whitespace-nowrap border border-spacing-1 cursor-pointer'>
                <x-sort :$sortDirection :$sortBy :field="'kota_tujuan'" />Kota Tujuan</th>
            <th @click="$wire.sortField('jam_berangkat')"
                class='p-2 whitespace-nowrap border border-spacing-1 cursor-pointer'>
                Jam Berangkat</th>
        </tr>
        <tr>
