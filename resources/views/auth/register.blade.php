        ...
        <x-slot name="logo">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="relative mt-4">
                    ...
                    <x-inputpassword type="password" name="password" id="password" placeholder="••••••••" required />
                ...
                <div class="relative mt-4 ">
                    ...
                    <x-inputpassword id="password_confirmation" class="block mt-1 w-full" type="password"
                        name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
                    <button type="button" id="toggleConfirmPassword"
                        class="absolute inset-y-12 right-0 flex items-center pr-3 focus:outline-none">
                        <span id="toggleConfirmPasswordText" class="text-gray-500 dark:text-white">Tampilkan</span>
                    </button>
                </div>
                <div class="hidden">
